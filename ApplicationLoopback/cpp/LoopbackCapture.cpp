    ...
    return SetDeviceStateErrorIfFailed([&]() -> HRESULT
        {
            ...
            audioclientActivationParams.ActivationType = AUDIOCLIENT_ACTIVATION_TYPE_DEFAULT;
            ...
            LPOLESTR  deviceInterfacePath;
            StringFromIID(DEVINTERFACE_AUDIO_RENDER, &deviceInterfacePath);
            wil::com_ptr_nothrow<IActivateAudioInterfaceAsyncOperation> asyncOp;
            RETURN_IF_FAILED(ActivateAudioInterfaceAsync(deviceInterfacePath, __uuidof(IAudioClient), nullptr, this, &asyncOp));
