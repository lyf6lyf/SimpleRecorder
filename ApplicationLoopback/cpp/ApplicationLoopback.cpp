...
int wmain(int argc, wchar_t* argv[])
{
    ...
    else
    {
        ...
        std::wcout << L"Mute." << std::endl;
        loopbackCapture.m_SimpleAudioVolume->SetMute(true, nullptr);

        Sleep(3000);

        std::wcout << L"UnMute." << std::endl;
        loopbackCapture.m_SimpleAudioVolume->SetMute(false, nullptr);
